...
export class CustomCurrencyPipe implements PipeTransform {
  ...
  transform(
    ...
    const { amount, currency, locale } = this.formatCurrency(numericValue, lang);
  ...
  private formatCurrency(value: number, lang: 'vi' | 'en'): { amount: number; currency: string, locale: string } {
